...
<div align="center">
    ...
    <a href="./assets/feishu.png"><img src="https://img.shields.io/badge/Feishu-Join-blue"></a>
</div>
...
## 🔥News!!!
- 2026/05/06: 🎉We released the **evaluation code** for MOVA! See [evaluation/](./evaluation/) for details.
...
## Evaluation
We release our evaluation code in the [**evaluation/**](./evaluation/) directory, which provides 11 metrics across 7 metric groups for assessing synchronized audio-visual video generation quality, including audio quality, lip-sync, AV alignment, and more.
